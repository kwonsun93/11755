...
video_path=/home/ubuntu/11775-hws/videos   # path to the directory containing all the videos. In this example setup, we are linking all the videos to "../video"
...
for line in $(cat "list/all.video"); do
    ffmpeg -y -i $video_path/${line}.mp4 -ac 1 -f wav /home/ubuntu/11775-hws/hw1_code/audio/$line.wav
    /home/ubuntu/tools/opensmile-2.3.0/SMILExtract -C config/MFCC12_0_D_A.conf -I /home/ubuntu/11775-hws/hw1_code/audio/$line.wav -O /home/ubuntu/11775-hws/hw1_code/mfcc/$line.mfcc.csv
done
...
mkdir -p asrfeat
python scripts/create_asrfeat.py /home/ubuntu/11775-hws/vocab/vocab list/all.video || exit 1;
